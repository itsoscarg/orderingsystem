...
{document.location.href=document.location.href;return;}});},0);});$(document).keydown(function(e){if(document.querySelector(".collection-content.edit-mode")||document.querySelector(".collection .edit-name.active"))
{return;}
...
{(function(){var premium_banner=document.getElementById("fi-premium-ads-premium");if(premium_banner&&premium_header)
{premium_banner.style.display=(!~~gr.auth.me.premium)?'block':'none';}})();}}
...
track_add_collection(document.location.pathname,icon,premium);premium=(icon.premium==1)?1:parseInt(premium,10);if(premium==1&&!gr.auth.me.premium){UserAlerts.warning('Ooops!',messages.collection.add_premium);return false;}
